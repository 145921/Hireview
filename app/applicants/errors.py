...
@applicants.app_errorhandler(403)
def forbidden(e):
    """
    ...
    return render_template('applicants/403.html'), 403


@applicants.app_errorhandler(404)
def page_not_found(e):
    ...
    return render_template('applicants/404.html'), 404


@applicants.app_errorhandler(500)
def internal_server_error(e):
    ...
    return render_template('applicants/500.html'), 500
